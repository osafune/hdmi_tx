...
SOPCINFO_FILE := C:/PROJECT/temp/hdmi_tx/hw/wavplayer/c4e_pcmplay_core.sopcinfo
...
# CPU Name 
# setting CPU_NAME is nios2_tiny
CPU_NAME = nios2_tiny
...
# Design Name 
# setting SOPC_NAME is c4e_pcmplay_core
SOPC_NAME := c4e_pcmplay_core
...
# The SOPC System ID 
# setting SOPC_SYSID is 2686648593
SOPC_SYSID_FLAG += --id=2686648593
ELF_PATCH_FLAG  += --id 2686648593
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1673399163
SOPC_SYSID_FLAG += --timestamp=1673399163
ELF_PATCH_FLAG  += --timestamp 1673399163
...
# setting hal.stderr is sysuart
ELF_PATCH_FLAG  += --stderr_dev sysuart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is sysuart
ELF_PATCH_FLAG  += --stdin_dev sysuart
...
# setting hal.stdout is sysuart
ELF_PATCH_FLAG  += --stdout_dev sysuart
